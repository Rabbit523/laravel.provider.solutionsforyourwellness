...
<?php
if($provider_id == ""){
	$form_submit_url = URL::route('add-certificate');
}else{
	$form_submit_url = URL::route('add_certificate_by_id',$provider_id);
}
?>
              ...
              <div class="col s12 m12 l12">
                  <div class="col s12 m12 l10">
                        <div class="card-panel">
                            ...
                            <div class="row">
                                {{ Form::open(['id'=>'add_certificate_form','class'=>'form-horizontal','files'=>'true','method'=>'post','role' => 'form', 'url' =>$form_submit_url]) }}
                                    <div class="row">
                                      <div class="col s12">
                                        ...
                                        <select class="browser-default" name="user_id" id="user_id" data-error=".errorTxt6">
                                          ...
                                          @foreach ($providers as $provider)
                                            <option value="{{ $provider->id }}" <?php if($provider_id == $provider->id){ echo 'selected'; }?>>{{ $provider->first_name }} {{ $provider->last_name }}</option>
                                          @endforeach
                                        </select>
