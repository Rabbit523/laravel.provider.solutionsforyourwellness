...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="{{ url('/admin/category-list') }}">Category List</a> <a href="javascript:void(0);" class="current">Edit Category</a> </div>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-pencil"></i> </span>
            <h5>Enter the details to edit category</h5>
          </div>
		  ...
		  @if(Session::has('flash_message_error'))
			...
			<div id = "error"></div>		
			<div id = "success"></div>		
		  {{ Form::open(['id'=>'editcategory_form','class'=>'form-horizontal','files'=>'true','method'=>'post','role' => 'form', 'url' => 'admin/edit-category/'.$category->id]) }}
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div id="form-wizard-1" class="step">
                <div class="control-group">
                  <label class="control-label">Dealer Price</label>
                  <div class="controls">
                    {{ Form::text('category_name',$category->category_name, ['id'=>'category_name','placeholder' => 'Enter the Category Name. ','autocomplete'=>false]) }}
				...
				<div class="control-group">
				 <label class="control-label">Description</label>
					<div class="controls">
					{{ Form::textarea('description',$category->description, ['class'=>'span11','id'=>'description','autocomplete'=>false,'placeholder'=>'Enter description']) }}
