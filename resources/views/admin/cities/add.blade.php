          ...
          <div class="row">
            <div class="col s12 m12 l12">
              ...
              <ol class="breadcrumbs">
                  ...
                  <li class="active">{{ trans('Add city') }}</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="col s12 m12 l12">
                  <div class="col s12 m12 l10">
                        <div class="card-panel">
                            ...
                            <div class="row">
                                {{ Form::open(['id'=>'city_form','class'=>'form-horizontal','files'=>'true','method'=>'post','role' => 'form', 'url' =>URL::route('add_city')]) }}
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <label for="name">City name*</label>
                                            {{ Form::text('city_name',null, ['class'=>'form-control','id'=>'city_name','autocomplete'=>false]) }}
									...
									<div class="row">
										 <div class="input-field col s6">
                                            ...
                                            {{ Form::text('description',null, ['class'=>'form-control','id'=>'description','autocomplete'=>false]) }}
                                        </div>
									</div>
