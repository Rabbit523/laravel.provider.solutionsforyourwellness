          ...
          <div class="row">
            <div class="col s12 m12 l12">
              ...
              <ol class="breadcrumbs">
                  ...
                  <li class="active">{{ trans('Edit admin') }}</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="col s12 m12 l12">
                  <div class="col s12 m12 l10">
                        <div class="card-panel">
                            <h4 class="header2">Edit admin</h4>
                            <div class="row">
                                {{ Form::open(['id'=>'edit_admin_form','class'=>'form-horizontal','files'=>'true','method'=>'post','role' => 'form', 'url' =>URL::route('edit-admin',$admin->id)]) }}
                                    <div class="row">
                                      <div class="input-field col s6">
                                          <label for="first_name">First name*</label>
                                          {{ Form::text('first_name',$admin->first_name, ['class'=>'form-control','id'=>'first_name','autocomplete'=>false]) }}
                                          @if ($errors->has('first_name')) <p class="help-block">{{ $errors->first('first_name') }}</p> @endif
                                      </div>
                                      <div class="input-field col s6">
                                          <label for="last_name">Last name*</label>
                                          {{ Form::text('last_name',$admin->last_name, ['class'=>'form-control','id'=>'last_name','autocomplete'=>false]) }}
                                          @if ($errors->has('last_name')) <p class="help-block">{{ $errors->first('last_name') }}</p> @endif
                                      </div>

                                      <div class="input-field col s6">
                                        <label for="email">E-mail *</label>
                                        {{ Form::text('email',$admin->email, ['class'=>'form-control','id'=>'email','autocomplete'=>false]) }}
                                        @if ($errors->has('email')) <p class="help-block">{{ $errors->first('email') }}</p> @endif
                                      </div>
                                      <div class="input-field col s6">
                                        <label for="phone">Phone no *</label>
                                        {{ Form::text('phone',$admin->phone, ['class'=>'form-control','id'=>'phone','autocomplete'=>false]) }}
