...
@section('content')
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      {{ Form::open(['class'=>'login-form','id'=>'forgot_password_form','role' => 'form', 'url' =>route('admin_forgot_password')]) }}
        <div class="row">
        ...
        <div class="row">
          <div class="input-field col s12">
			{{Form::submit('Reset Password',array('class'=>'btn waves-effect waves-light col s12'))}}
          </div>
        </div>
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="{{ URL::route('adminlogin') }}">Login ?</a></p>
          </div>
        </div>
      {{ Form::close() }}
    </div>
